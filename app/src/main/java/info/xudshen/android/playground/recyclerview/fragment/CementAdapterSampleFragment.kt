...
import info.xudshen.android.playground.cement.eventhook.OnLongClickEventHook
 ...
 * @since 2017/2/7
 */
class CementAdapterSampleFragment : Fragment() {
    //not right, just for no more error
    var adapter: CementAdapter = CementAdapter()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.setOnItemClickListener { _, _, _, absModel ->
            when (absModel) {
                is ButtonModel -> {
        ...
        adapter.addEventHook(object : OnLongClickEventHook<ButtonModel.ViewHolder>(ButtonModel.ViewHolder::class.java) {
            override fun onLongClick(view: View, viewHolder: ButtonModel.ViewHolder, position: Int, rawModel: CementModel<*>): Boolean {
    ...
    class ButtonModel(var title: String) : CementModel<ButtonModel.ViewHolder>() {
        ...
        override fun getViewHolderCreator(): CementAdapter.IViewHolderCreator<ViewHolder> =
                CementAdapter.IViewHolderCreator { view -> ViewHolder(view) }
    ...
    class TextModel(val index: Int, var clicked: Boolean = false) : CementModel<TextModel.ViewHolder>(index.toLong()) {
    ...
    class HorizontalListModel(id: Long) : CementModel<HorizontalListModel.ViewHolder>(id) {
