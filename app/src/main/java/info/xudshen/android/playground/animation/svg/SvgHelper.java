...
/**
 * ref:https://github.com/romainguy/road-trip/blob/master/application/src/main/java/org/curiouscreature/android/roadtrip/SvgHelper.java
 */
public class SvgHelper {
    ...
    public List<SvgPath> getPathsForViewport(final int width, final int height) {
        ...
        Canvas canvas = new Canvas() {
            /**
             * calculate by canvas.translate, canvas.scale
             */
        ...
        //scale the path drawn on the canvas
